  ...
  <Col md={12} lg={12} xl={12}>
    <Card>
      <ProfileCard>
        ...
        <ProfileStats>
          <ProfileStat>
            <ProfileStatNumber>10</ProfileStatNumber>
            <ProfileStatTitle>Total Vehicles</ProfileStatTitle>
          </ProfileStat>
          <ProfileStat>
            <ProfileStatNumber>8</ProfileStatNumber>
            <ProfileStatTitle>Working</ProfileStatTitle>
          </ProfileStat>
          <ProfileStat>
            <ProfileStatNumber>2</ProfileStatNumber>
            <ProfileStatTitle>Not Working</ProfileStatTitle>
          </ProfileStat>
        </ProfileStats>
      </ProfileCard>
    </Card>
